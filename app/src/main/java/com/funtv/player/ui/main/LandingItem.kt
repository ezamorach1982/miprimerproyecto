...
sealed class LandingItem(val titleRes: Int, val drawableRes: Int) {
    object LiveTv : LandingItem(R.string.header_live, R.drawable.bg_live)
    object Movies : LandingItem(R.string.header_movies, R.drawable.bg_movies)
    object Series : LandingItem(R.string.header_series, R.drawable.bg_series)
}
